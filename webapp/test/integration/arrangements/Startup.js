sap.ui.define([
	"sap/ui/test/Opa5",
	"fatihpense/ui/example/example-ui5-tooling/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("fatihpense.ui.example.example-ui5-tooling.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "fatihpense.ui.example.example-ui5-tooling",
					async: true
				},
				hash: oOptions.hash,
